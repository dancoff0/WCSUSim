        ...
        this.commands.put("set", new Command() {
            ...
            public String doCommand(final String[] array, final int n) {
                ...
                if (n == 2) {
                    ...
                    if (n == 3) {
                        return "Memory location " + Word.toHex(address) + " updated to " + array[n - 1];
                    }
                    return "Memory locations " + Word.toHex(address2) + " to " + Word.toHex(address2) + " updated to " + array[n - 1];
                }
            }
        });
