...
public class Console
{
  ...
  private static List<PrintableConsole> consoles;

  public Console()
  {
    throw new UnsupportedOperationException( "edu.wcsu.WCSUSim.Display.Console is meant to be used statically." );
  }
  ...
  static
  {
    ...
    Console.consoles = new LinkedList<PrintableConsole>();
  }
}
