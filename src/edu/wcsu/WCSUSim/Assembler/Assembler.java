...
{
  public String as( final String[] array ) throws AsException
  {
    String s = null;
  ...
  private String base_filename( final String s ) throws AsException
  {
    if( !s.endsWith( ".asm" ) )
    {
  ...
  private List<Instruction> parse( final String s ) throws AsException
  {
  ...
  private void pass_one( final SymTab symTab, final List<Instruction> list ) throws AsException
  {
    int nextAddress = -1;
  ...
  private void pass_two( final SymTab symTab, final List<Instruction> list, final String s ) throws AsException
  {
  ...
  private void gen_sym( final SymTab symTab, final List<Instruction> list, final String s ) throws AsException
  {
